...
class ExpriyDateCalculatorTest {
    ...
    void 만원_납부하면_한달_뒤가_만료일이_됨(){
        ...
        assertExpriyDate(LocalDate.of(2019,5,31), 10_000, LocalDate.of(2019,6,30));
        assertExpriyDate(LocalDate.of(2020,1,31), 10_000, LocalDate.of(2020,2,29));
    }

    @Test
    void 납부일과_힌달_뒤_일자가_같지_않음(){
        assertExpriyDate(LocalDate.of(2019,1,31),10_000, LocalDate.of(2019,2,28));
    }
